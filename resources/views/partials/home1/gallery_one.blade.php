                ...
                <div class="gallery-one__single">
                    <div class="gallery-one__img">
                        ...
                        <div class="gallery-one__icon">
                            <a class="img-popup" href="{{ asset('assets/images/gallery/gallery-1-1.jpg') }}"><span
            ...
            <div class="item">
                <div class="gallery-one__single">
                    <div class="gallery-one__img">
                        ...
                        <div class="gallery-one__icon">
                            <a class="img-popup" href="{{ asset('assets/images/gallery/gallery-1-2.jpg') }}"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="gallery-one__single">
                    <div class="gallery-one__img">
                        ...
                        <div class="gallery-one__icon">
                            <a class="img-popup" href="{{ asset('assets/images/gallery/gallery-1-3.jpg') }}"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="gallery-one__single">
                    <div class="gallery-one__img">
                        ...
                        <div class="gallery-one__icon">
                            <a class="img-popup" href="{{ asset('assets/images/gallery/gallery-1-4.jpg') }}"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="gallery-one__single">
                    <div class="gallery-one__img">
                        ...
                        <div class="gallery-one__icon">
                            <a class="img-popup" href="{{ asset('assets/images/gallery/gallery-1-5.jpg') }}"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
