...
<section class="gallery-two">
    <div class="container">
        <div class="section-title text-center">
            <span class="section-title__tagline">look photos</span>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="gallery-two__single">
                    <div class="gallery-two__img">
                        ...
                        <div class="gallery-two__icon">
                            <a class="img-popup" href="assets/images/gallery/gallery-2-1.jpg"><span
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="gallery-two__single">
                    <div class="gallery-two__img">
                        ...
                        <div class="gallery-two__icon">
                            <a class="img-popup" href="assets/images/gallery/gallery-2-2.jpg"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="gallery-two__single">
                    <div class="gallery-two__img">
                        ...
                        <div class="gallery-two__icon">
                            <a class="img-popup" href="assets/images/gallery/gallery-2-3.jpg"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="gallery-two__single">
                    <div class="gallery-two__img">
                        ...
                        <div class="gallery-two__icon">
                            <a class="img-popup" href="assets/images/gallery/gallery-2-4.jpg"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="gallery-two__single">
                    <div class="gallery-two__img">
                        ...
                        <div class="gallery-two__icon">
                            <a class="img-popup" href="assets/images/gallery/gallery-2-5.jpg"><span
                                    class="fa fa-plus"></span></a>
                        </div>
                    </div>
                </div>
